...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let blueVC : ViewController = ViewController(nibName: "ViewController", bundle: nil)
        blueVC.view.backgroundColor = UIColor.blue
        
        blueVC.tabBarItem.title = "Blue"
        
        let yellowVC : ViewController = ViewController(nibName: "ViewController", bundle: nil)
        ...
        tabController.viewControllers = [vc, blueVC, yellowVC]
